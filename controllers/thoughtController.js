...
module.exports = {
  ...
  createThought(req, res) {
    Thought.create(req.body)
      ...
      .then((user) =>
        !user
          ? res.status(404).json({
              message: 'Thought created, but found no user found with that ID',
            })
  ...
  // Deletes a thought from the database, by looking for a thought with an id
